...
export default function recentnews() {
 return (
    <section className="mx-auto flex max-w-348 flex-col gap-6 bg-[#CA433C] px-6 py-6 text-white md:h-76 md:flex-row md:items-center md:justify-between md:px-20">
